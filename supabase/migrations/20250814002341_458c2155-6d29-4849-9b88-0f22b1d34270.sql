-- Insert mock client data with proper UUIDs
INSERT INTO public.clients (
  name, status, team, csm, start_date, end_date, contract_value, 
...
('Acme Corporation', 'active', 'enterprise', 'John Smith', '2023-01-01', '2024-01-01', 50000, 
...
('Globex Industries', 'at-risk', 'mid-market', 'Jane Doe', '2022-11-15', '2023-11-15', 25000,
...
('Initech Software', 'new', 'smb', 'David Johnson', '2023-05-01', '2023-11-01', 10000,
...
('Massive Dynamic', 'active', 'enterprise', 'Sarah Williams', '2023-02-15', '2024-02-15', 75000,
...
('Stark Industries', 'churned', 'mid-market', 'Michael Brown', '2022-08-01', '2023-08-01', 30000,
...
('Wayne Enterprises', 'active', 'enterprise', 'John Smith', '2023-03-15', '2024-03-15', 65000,
...
('Umbrella Corporation', 'at-risk', 'enterprise', 'Sarah Williams', '2022-10-01', '2023-10-01', 55000,
...
('Cyberdyne Systems', 'new', 'mid-market', 'Jane Doe', '2023-06-01', '2024-06-01', 28000,
 'Recently migrated from competitor, needs extra support', 30, NULL, 2, 1, 2000,
 5, 0, '2023-11-01', 2000, '2023-11-01', NULL, NULL, NULL,
 false, NULL, false, 'Too early for case study', 0, ARRAY[]::text[]),

('Soylent Corp', 'active', 'smb', 'David Johnson', '2023-01-15', '2024-01-15', 12000,
